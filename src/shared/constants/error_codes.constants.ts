...
export const CredentialErrorCodes = {
  INVALID_CREDENTIAL_REQUEST: { code: "invalid_credential_request", httpStatus: 400 },
  UNSUPPROTED_CREDENTIAL_TYPE: { code: "unsupported_credential_type", httpStatus: 400 },
  UNSUPPORTED_CREDENTIAL_FORMAT: { code: "unsupported_credential_format", httpStatus: 400 },
