...
} from '../../../../../shared/classes/patterns/chain_of_responsability.js';
import {ChainHandler} from '../../../../../shared/classes/utility/handler.js';
import {Result} from '../../../../../shared/classes/utility/result.js';
import {
...
export class ChainCheckAccreditationType extends LazyChainOfResponsability {
  ...
  constructor(types: string[]) {
    super();
    this._types = (types as EbsiAccreditationType[]).filter(x =>
      ACCREDITATIONS_TYPES.includes(x),
    );
  }
  ...
  public isAccreditation(): ChainCheckAccreditationType {
    this.addHandler(
      new (class extends ChainHandler {
